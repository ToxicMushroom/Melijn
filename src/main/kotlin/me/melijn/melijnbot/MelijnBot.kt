...
class MelijnBot {
    ...
    init {
        ...
        val jdaLavaLink = runBlocking { generateJdaLinkFromNodes(container, container.settings.lavalink.verified_nodes) }
        val premiumJdaLavaLink = runBlocking { generateJdaLinkFromNodes(container, container.settings.lavalink.http_nodes) }
    ...
    private suspend fun generateJdaLinkFromNodes(container: Container, httpNodes: Array<Settings.Lavalink.Node>): JDALavalink? {
