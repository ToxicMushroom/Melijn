...
//    class CharacterArg(parent: String) : AbstractCommand("$parent.") {
//
//        init {
//            name = "character"
//            aliases = arrayOf("char", "c")
//        }
//
//        override suspend fun execute(context: CommandContext) {
//            if (context.args.isEmpty()) {
...
//
//                val eb = Embedder(context)
//                eb.setTitle("Character: ${result.username}", result.url)
//
...
//
//                        eb.addField(
//                            context.getTranslation("favorite.anime"),
//                            top.joinToString("\n") { anime ->
...
//
//                        eb.addField(
//                            context.getTranslation("favorite.manga"),
//                            mangaList
//                                .joinToString("\n") { manga ->
...
//
//                        eb.addField(
//                            context.getTranslation("favorite.character"),
