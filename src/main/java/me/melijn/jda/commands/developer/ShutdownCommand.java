...
public class ShutdownCommand extends Command {
    ...
    protected void execute(CommandEvent event) {
        File file = new File(Melijn.class.getClassLoader().getResource("Melijn.mp3").getFile());

        //save players before shutdown
        //Duncte rated: niet mooi
        ...
        players.forEachValue((player) -> {
            ...
            MusicManager.getManagerInstance().loadSimpleTrack(player.getGuild(), file.getPath());
            return true;
        });
